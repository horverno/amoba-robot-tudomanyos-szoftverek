...
{
    public class Camera : Interface.IImageProcessing
    {
        ...
        private bool isRectInRect(Rectangle r1, Rectangle r2, out byte eb)
        {
            //mi         miben              //error bit
        ...
        private Image<Bgr, Byte> DrawGrid(Image<Bgr, Byte> img, Point lu, Point ru, Point ld, Point rd, int cellNumX, int cellNumY)
        {
            ...
            //felveendő bábu helyének kirajzolása
            ...
            result.Draw(new CircleF(new PointF(574, 359), 40), pieceCircleColor, 4);
            //result.Draw(new CircleF(new PointF(490, 360), 40), pieceCircleColor, 4);
            return result;
        }
        ...
        public void OnNextPieceChanged(Piece newStatus)
        {
        ...
        //Kalibrálás alatt kirajzolt kép
        private Image<Bgr, Byte> DrawCalib(Image<Bgr, Byte> img)
        {
            Image<Bgr, Byte> result = img.Copy();
